...
def init_database():
    ...
    if engine is None:
        ...
        # Convert any PostgreSQL URL format to pg8000 format
        ...
        # pg8000 connection arguments - simpler as it handles UTF-8 natively
        connect_args = {
        ...
        SessionLocal = sessionmaker(
            ...
            autoflush=False, 
            bind=engine,
            expire_on_commit=False  # Production setting
        )
